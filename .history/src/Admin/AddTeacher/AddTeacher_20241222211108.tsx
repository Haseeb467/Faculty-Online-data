...
import { txtDB, storage } from "@/firebasedbconfig/dbconfig";
        ...
        uploadTask.on('state_changed',
          ...
          () => {
            getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
              ...
              setData( (prev)=>{...prev, imgdownloadURL} )
            });
          }
        );
      };
        ...
        <div className="w-full flex ">
          ...
          <div className="w-1/2 flex flex-col  items-center ">
            ...
            <label htmlFor="image" className="cursor-pointer w-[110px]">
              <img
                src={!file ? upload : file instanceof File ? URL.createObjectURL(file) : upload}
                alt="Upload thumbnail" className="ml-2  m-1 w-[100px] h-[100px] object-cover" />
            </label>
            <input
              onChange={(e) => {
