        ...
        <div className="w-full flex ">
          ...
          <div className="w-1/2 flex flex-col  items-center ">
            ...
            <label htmlFor="image" className="cursor-pointer w-[110px]">
              <img src={!image ? uploadString : image instanceof File ? URL.createObjectURL(image) : upload} alt="Upload thumbnail" className="ml-2  m-1 w-[100px] h-[100px] object-cover" />
            </label>
            <input
              onChange={(e) => {
