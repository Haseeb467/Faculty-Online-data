      ...
      >
        ...
        <div className="w-full mt-2 flex  ">
          <div className="w-1/2 flex flex-col">
            ...
            <label htmlFor=" <label htmlFor="contactno" className="text-lg pt-2 pb-1 font-medium cursor-pointer">Contact No. </label>
            <input type="text" name="contactno" onChange={onChangeHandler} value={data.contactno} id="contactno" className="w-10/12 px-2 py-2 bg-transparent border-2 border-zinc-500 rounded-lg" />
         " className="text-lg pt-2 pb-1 font-medium cursor-pointer">Contact No. </label>
            <input type="text" name="contactno" onChange={onChangeHandler} value={data.contactno} id="contactno" className="w-10/12 px-2 py-2 bg-transparent border-2 border-zinc-500 rounded-lg" />
