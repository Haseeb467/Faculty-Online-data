      ...
      >
        ...
        <div className="w-full mt-2 flex  ">
          <div className="w-1/2 flex flex-col">
            ...
            <input type="text" name="landlineno" onChange={onChangeHandler} value={data.contactno} id="contactno" className="w-10/12 px-2 py-2 bg-transparent border-2 border-zinc-500 rounded-lg" />
