// 'use client'
// // import blod_data from "@/assets./asset.js"
// // import blog_data from '@/assets/asset.json';
...
//                 <div key={index} className="flex flex-col max-w-[320px] px-4 py-5  border-2 border-orange-500 rounded-md h-[320px]">

//                     <div className="flex">
//                         <div className="data ">
//                             <h3>Name : {teacherData.name}</h3>
//                             <p>Gender : {teacherData.gender}</p>
//                             <p>CNIC : {teacherData.cnic}</p>
//                             <h4>Department : {teacherData.department}</h4>
//                             <h4>Degree : {teacherData.latestAcademicDegree}</h4>
//                             <h5>Email : {teacherData.email}</h5>
//                             <h5>Contact : {teacherData.contactNo}</h5>
//                             <h5>Landline : {teacherData.landlineNo}</h5>
//                         </div>
//                         <div className="image w-[100px] h-[100px] border-2">adlks</div>
//                     </div>
...
import { txtDB } from '@/firebasedbconfig/dbconfig'; // Adjust the import path if necessary
...
const MainPageItems = () => {
    // const navigate = useNavigate(); // Use navigate for React Route r  
    const [gdata, setGdata] = useState<TeacherData[]>([]);
    const [loading, setLoading] = useState(false);
                ...
                <div key={index} className="flex flex-col min-w-[350px] px-4 py-5 border-2 border-orange-500 rounded-md h-[380px]">
                    <div className="flex">
                        <div className="data space-y-1">
                            ...
                            {/* Display landline number from Firebase */}
                        </div>
                        {/* <div className="image w-[100px] h-[100px] border-2">adlks</div> */}
                    </div>
