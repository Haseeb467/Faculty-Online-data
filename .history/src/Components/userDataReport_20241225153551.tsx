...
const AddTeacher = () => {
    ...
    const generatePDF = () => {
        ...
        const tableColumn = ["Name", "Department", "Email", "Contact No", "Status"];
        const tableRows: any[] = [];
                    ...
                    <table className="w-full text-sm text-gray-700">
                        <thead className="bg-gray-400 text-left uppercase">
                            <tr>
                                ...
                                <th className="px-4 py-2">Email</th><th className="px-4 py-2">Status</th><th className="px-4 py-2">Status</th>
                            </tr>
                        </thead>
                        <tbody>
