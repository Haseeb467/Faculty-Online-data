...
// ... existing code ...
// const user = await signInWithEmailAndPassword(auth, data.email, password);
...
const LoginForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            // for user signin with email and password
            console.log("hi iam log");
            ...
            // console.log("User logged in as uid:", userCred.user.uid);
            ...
            if (userDoc.exists()) {
                // console.log("User logged in as uid  in if:", user.user.uid);
                ...
                // console.log("its userDocdata ok inside if:  ", userDoc.data());

                const userData = userDoc.data() // as UserData;
                // console.log("User data fetched in if:", userData)
                ...
                // If roles match, proceed with navigation
