            ...
            <div className="link ">
                <nav className="mt-8">
                    <ul className="space-y-4">
                        <li className="cursor-pointer py-1 px-3 rounded hover:text-black hover:bg-gray-100">
                            <NavLink
                                to="/admin/add-teacher"
                                className={({ isActive }) =>
                                    `cursor-pointer py-1 px-3 rounded hover:text-black hover:bg-gray-100 ${isActive ? "text-black border-l-4 border-black bg-gray-200" : ""}`
                                }
                            >
                                Add Teacher
                            </NavLink>
